...
type LastKeyAcross struct {
	LastKeyCommitTime int64 `map:"lastKeyCommitTime" json:"lastKeyCommitTime" yaml:"lastKeyCommitTime"`
	LastKeyUpdateTime int64 `map:"lastKeyUpdateTime" json:"lastKeyUpdateTime" yaml:"lastKeyUpdateTime"`
	TaskID            string `map:"taskId" json:"taskId" yaml:"taskId"`
	GroupID           string `map:"groupId" json:"groupId" yaml:"groupId"`
}
